...
from trainer import trainer_synapse, trainer_liver
...
parser.add_argument('--val_ratio', type=float, default=0.2, help='Ratio of validation set split')
...
if __name__ == "__main__":
    ...
    # trainer = {'Synapse': trainer_synapse, 'Mine': trainer_mine}
    # trainer_synapse(args, net, args.output_dir)
    trainer_liver(args, net, args.output_dir)
